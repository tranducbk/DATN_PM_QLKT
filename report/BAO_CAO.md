...
Đồ án tốt nghiệp này được hoàn thành sau quá trình học tập và nghiên cứu tại Trường Công nghệ Thông tin và Truyền thông – Đại học Bách Khoa Hà Nội. Em bày tỏ lòng biết ơn tới các thầy, cô trong Khoa đã trang bị cho em nền tảng tri thức vững chắc về Khoa học máy tính trong suốt bốn năm vừa qua, cũng như đã tạo điều kiện cho em được tiếp xúc với các bài toán thực tế ngay từ những học kỳ đầu.

Em gửi lời tri ân sâu sắc tới ThS. Lê Đức Trung — giảng viên hướng dẫn — vì đã đồng hành cùng em ngay từ giai đoạn xác định đề tài, kiên nhẫn phản biện từng bản nháp và định hướng phương pháp nghiên cứu trong suốt quá trình thực hiện. Những góp ý cụ thể của thầy về kiến trúc phần mềm, cách trừu tượng hoá quy tắc nghiệp vụ và cách bảo vệ luận điểm đã giúp đồ án tránh được nhiều sai sót và hoàn thiện hơn rất nhiều so với phiên bản ban đầu.

Em chân thành cảm ơn tập thể cán bộ Học viện Khoa học Quân sự — cụ thể là Thượng tá ThS. Đặng Quốc Hưng, Trung tá ThS. Bùi Đình Thế cùng các đồng chí trong nhóm thực hiện đề tài cấp Học viện mã số ĐTHV/2025-2026/H5-01 — đã chia sẻ kiến thức nghiệp vụ về công tác thi đua – khen thưởng trong môi trường quân sự, cung cấp các biểu mẫu thực tế và phản hồi chi tiết về luồng nghiệp vụ trong giai đoạn xây dựng phần mềm. Cuối cùng, em biết ơn gia đình và bạn bè đã luôn ủng hộ em về mặt tinh thần trong suốt thời gian thực hiện đồ án.

Do giới hạn về thời gian và kinh nghiệm, đồ án không tránh khỏi những thiếu sót. Em rất mong nhận được ý kiến đóng góp từ các thầy, cô để hoàn thiện hơn nữa.
...
**Đoạn 1 — Bối cảnh đặc thù.** Công tác thi đua, khen thưởng tại các đơn vị thuộc Bộ Quốc phòng tuân thủ Luật Thi đua, Khen thưởng số 06/2022/QH15 cùng các nghị định, thông tư hướng dẫn ban hành kèm theo, đồng thời được cụ thể hoá bởi các văn bản chỉ đạo nội bộ như Nghị quyết số 1658/NQ-QUTW ngày 20/12/2022 của Quân uỷ Trung ương về khoa học, công nghệ, đổi mới sáng tạo và Nghị quyết số 1405/NQ-ĐU ngày 11/4/2023 của Đảng uỷ Học viện Khoa học Quân sự. Tại Học viện, riêng nhóm khen thưởng cá nhân hằng năm bao gồm chuỗi ba cấp Bằng khen của Bộ trưởng Bộ Quốc phòng (BKBTBQP), Chiến sĩ thi đua toàn quân (CSTĐTQ) và Bằng khen của Thủ tướng Chính phủ (BKTTCP) — mỗi cấp có chu kỳ trượt khác nhau (2, 3 và 7 năm) và yêu cầu đối chiếu nhiều cờ trong cửa sổ thời gian, làm cho việc xét chọn thủ công trên Excel rất dễ sai sót.
...
| CQĐV | Cơ quan đơn vị (cấp cha) — _định danh kỹ thuật trong mã nguồn_ |
| ĐVTT | Đơn vị trực thuộc (cấp con thuộc CQĐV) — _định danh kỹ thuật_ |
...
| BKBTBQP | Bằng khen của Bộ trưởng Bộ Quốc phòng (chu kỳ 2 năm CSTĐCS) |
| CSTĐTQ | Chiến sĩ thi đua toàn quân (chu kỳ 3 năm + 1 BKBTBQP) — định danh code: `CSTDTQ` |
| BKTTCP | Bằng khen của Thủ tướng Chính phủ (chu kỳ 7 năm + 3 BKBTBQP + 2 CSTĐTQ; cá nhân là một lần duy nhất) |
...
Công tác thi đua – khen thưởng trong Quân đội Nhân dân Việt Nam được điều chỉnh bởi Luật Thi đua, Khen thưởng số 06/2022/QH15 [1] (sửa đổi từ Luật số 15/2003/QH11 [2]), cùng các nghị định, thông tư hướng dẫn của Chính phủ và Bộ Quốc phòng. Trong đó, Quyết định số 749/QĐ-TTg ngày 03/6/2020 của Thủ tướng Chính phủ phê duyệt Chương trình Chuyển đổi số quốc gia [4] đã ưu tiên ứng dụng công nghệ thông tin trong quản lý hành chính nhà nước, bao gồm cả lĩnh vực quốc phòng. Ở cấp Quân uỷ Trung ương, Nghị quyết số 1658/NQ-QUTW ngày 20/12/2022 [5] nêu rõ định hướng đẩy mạnh khoa học, công nghệ và đổi mới sáng tạo trong toàn quân. Tại Học viện, Nghị quyết số 1405/NQ-ĐU ngày 11/4/2023 của Đảng uỷ Học viện Khoa học Quân sự (HVKHQS) [9] đặt nhiệm vụ triển khai dần các phần mềm quản lý nội bộ phục vụ những mảng nghiệp vụ trọng yếu, trong đó có công tác thi đua – khen thưởng.

Trong nội bộ HVKHQS, nhiệm vụ cập nhật danh sách quân nhân đủ điều kiện, lập tờ trình, đối chiếu chu kỳ xét và lưu trữ quyết định từ trước tới nay vẫn được tiến hành chủ yếu trên các tệp Microsoft Excel chia sẻ qua mạng nội bộ kèm bản giấy ký xác nhận. Phương thức này phát sinh ba nhóm khó khăn cụ thể được trình bày dưới đây.

Thứ nhất, hệ thống danh hiệu có yếu tố **chuỗi** với cửa sổ thời gian trượt phức tạp. Để xét Bằng khen của Bộ trưởng Bộ Quốc phòng (BKBTBQP), một quân nhân phải duy trì danh hiệu Chiến sĩ thi đua cơ sở (CSTĐCS) liên tục đủ hai năm; xét Chiến sĩ thi đua toàn quân (CSTĐTQ) cần ba năm liên tục đồng thời có ít nhất một BKBTBQP nằm trong cửa sổ ba năm cuối; và xét Bằng khen của Thủ tướng Chính phủ (BKTTCP) cần bảy năm CSTĐCS liên tục cùng đúng ba BKBTBQP và đúng hai CSTĐTQ trong cửa sổ bảy năm cuối, kèm yêu cầu mỗi năm phải có thành tích nghiên cứu khoa học. Khi rà soát thủ công, cán bộ phải tra chéo nhiều bảng tính để xác định xem một danh hiệu cũ còn nằm trong cửa sổ trượt hay đã rơi ra ngoài, vừa chậm vừa dễ sai sót.

Thứ hai, hệ thống khen thưởng tại Học viện gồm **bảy nhóm khen thưởng** với nghiệp vụ tách bạch: khen thưởng cá nhân hằng năm, khen thưởng đơn vị hằng năm, niên hạn (Huy chương Chiến sĩ vẻ vang theo mốc 10/15/20 năm phục vụ), cống hiến (Huân chương Bảo vệ Tổ quốc dựa trên thời gian giữ chức vụ theo từng nhóm hệ số), kỷ niệm chương (vì sự nghiệp xây dựng Quân đội nhân dân Việt Nam, một lần duy nhất theo giới tính), Huy chương Quân kỳ quyết thắng (25 năm phục vụ) và thành tích nghiên cứu khoa học. Mỗi nhóm có quy tắc đầu vào, mẫu quyết định và quy trình duyệt riêng, vì vậy duy trì bằng tệp tính khó đảm bảo nhất quán giữa các nhóm.
...
3. Tự động kiểm tra điều kiện chuỗi (BKBTBQP, CSTĐTQ, BKTTCP đối với cá nhân; BKBTBQP và BKTTCP đối với đơn vị) và sinh thông điệp gợi ý dễ hiểu cho cán bộ.
...
1. **Cá nhân hằng năm** (`CA_NHAN_HANG_NAM`): danh hiệu CSTT, CSTĐCS, BKBTBQP, CSTĐTQ, BKTTCP cộng các cờ tương ứng và số quyết định cấp cao hơn.
2. **Đơn vị hằng năm** (`DON_VI_HANG_NAM`): danh hiệu ĐVQT, ĐVTT cộng các cờ BKBTBQP / BKTTCP cấp đơn vị.
...
Đây là module nghiệp vụ phức tạp nhất của hệ thống do có quy tắc chuỗi với cửa sổ trượt và có một danh hiệu lifetime. Cấu hình chuỗi cá nhân gồm ba tier (BKBTBQP, CSTĐTQ, BKTTCP) tương ứng ba phần tử trong mảng `PERSONAL_CHAIN_AWARDS`:

- **BKBTBQP** có chu kỳ 2 năm (yêu cầu 2 năm CSTĐCS liên tục), không yêu cầu cờ tiền điều kiện, có yêu cầu thành tích NCKH mỗi năm, không phải lifetime (có thể nhận lại sau mỗi chu kỳ 2 năm).
- **CSTĐTQ** có chu kỳ 3 năm, yêu cầu đúng 1 BKBTBQP nằm trong cửa sổ trượt 3 năm gần nhất tính từ năm trước năm xét, yêu cầu NCKH mỗi năm, không phải lifetime.
- **BKTTCP** có chu kỳ 7 năm, yêu cầu đúng 3 BKBTBQP và đúng 2 CSTĐTQ trong cửa sổ trượt 7 năm cuối, yêu cầu NCKH mỗi năm, **là lifetime** đối với cá nhân (mỗi quân nhân chỉ nhận một lần trong toàn bộ thời gian phục vụ).
...
- **BKBTBQP đơn vị** chu kỳ 2 năm, yêu cầu 2 năm ĐVQT liên tục, không có cờ tiền điều kiện, không phải lifetime.
- **BKTTCP đơn vị** chu kỳ 7 năm, yêu cầu ít nhất 3 BKBTBQP đơn vị trong cửa sổ trượt 7 năm cuối, không phải lifetime (đơn vị có thể nhận lại sau mỗi chu kỳ 7 năm).
...
| Luồng thay thế | (4a) Có quân nhân không đủ điều kiện trong danh sách (ví dụ chuỗi CSTĐCS chưa đủ 2 năm cho BKBTBQP) → hệ thống hiển thị cảnh báo nhưng vẫn cho phép gửi nếu Manager chấp nhận trách nhiệm. (3a) Manager chọn quân nhân ngoài phạm vi đơn vị → backend trả lỗi 403. (7a) Có lỗi mạng hoặc backend không phản hồi → frontend lưu nháp ở localStorage để người dùng không mất dữ liệu. |
...
| `co_quan_don_vi_id` | String | FK → CoQuanDonVi | Liên kết tới CQĐV (có thể NULL nếu thuộc ĐVTT) |
| `don_vi_truc_thuoc_id` | String | FK → DonViTrucThuoc | Liên kết tới ĐVTT (có thể NULL nếu thuộc CQĐV) |
...
| `so_quyet_dinh_bkbqp` | String | NULL | Số quyết định nếu có BKBTBQP |
...
Ràng buộc duy nhất `(quan_nhan_id, nam)` đảm bảo mỗi quân nhân chỉ có một bản ghi cho một năm. Các cờ `nhan_*` cho phép cộng dồn các tier chuỗi vào cùng năm — một quân nhân có thể vừa nhận BKBTBQP vừa duy trì CSTĐCS trong cùng một năm.
...
| `du_dieu_kien_bkbqp` | Boolean | DEFAULT false | Cờ đủ điều kiện đề nghị BKBTBQP |
...
**Trang chủ Admin** có cấu trúc ba khu vực: thanh điều hướng bên trái (cây CQĐV — ĐVTT có thể thu gọn), khu vực dashboard ở giữa với bốn thẻ thống kê (tổng quân nhân, tổng đơn vị, đề xuất chờ duyệt, khen thưởng tháng này), khu vực phụ bên phải với danh sách thông báo realtime. Bố cục ba khu vực này được giữ nhất quán xuyên suốt các trang nghiệp vụ chính (Quản lý quân nhân, Quản lý đề xuất, Quản lý quyết định) để giảm chi phí học thuộc cho người dùng mới.
...
>
> **Hình 4.41**: Thanh tiến trình chu kỳ chuỗi BKBTBQP/CSTĐTQ/BKTTCP trong tab Hằng năm.
...
| 3 | Quân nhân không đủ điều kiện | đề nghị BKBTBQP cho người chỉ có 1 năm CSTĐCS | Hiển thị cảnh báo trước khi gửi | Đạt |
...
| STT | Chức năng | Đầu vào | Đầu ra mong muốn | Kết quả |
|---|---|---|---|---|
| 1 | Tính lại quân nhân chưa nhận | 2 năm CSTĐCS liên tục | Đề nghị BKBTBQP, gợi ý giải thích | Đạt |
| 2 | Đã nhận BKTTCP (lifetime) | Quân nhân đã có BKTTCP | "Đã có BKTTCP. Phần mềm chưa hỗ trợ..." | Đạt |
| 3 | Bỏ lỡ đợt | 5 năm CSTĐCS kể từ BKBTBQP cuối | `missedBkbqp = 2`, vẫn đề nghị BKBTBQP mới | Đạt |
| 4 | Cửa sổ trượt 3 năm CSTĐTQ | BKBTBQP của 4 năm trước | BKBTBQP đó không tính, yêu cầu BKBTBQP mới | Đạt |
...
// 9–13. Các bảng khen thưởng output (HCBVTQ / HCQKQT / KNC / HCCSVV / KhenThuongDotXuat)
//   — xem nguyên văn tệp BE-QLKT/prisma/schema.prisma từ dòng 222 đến 347.
//   Mỗi model có cùng pattern: id, quan_nhan_id (hoặc co_quan_don_vi_id / don_vi_truc_thuoc_id),
//   danh_hieu / hinh_thuc_khen_thuong, nam + thang, cap_bac, chuc_vu, ghi_chu,
//   so_quyet_dinh (FK sang FileQuyetDinh), thoi_gian (Json), createdAt, updatedAt.

// 14. Bảng Hồ sơ Niên hạn (suy diễn)
model HoSoNienHan {
  id                      String    @id @default(cuid()) @db.VarChar(30)
  quan_nhan_id            String    @unique @db.VarChar(30)
...
// 15. Bảng Hồ sơ Cống hiến (suy diễn)
model HoSoCongHien {
  id                      String    @id @default(cuid()) @db.VarChar(30)
  quan_nhan_id            String    @unique @db.VarChar(30)
...
// 16. Bảng Hồ sơ Hằng năm (suy diễn)
model HoSoHangNam {
  id                  String   @id @default(cuid()) @db.VarChar(30)
  quan_nhan_id        String   @unique @db.VarChar(30)
...
// 20–21. Bảng Hồ sơ và Danh hiệu Đơn vị Hằng năm
//   — xem nguyên văn từ dòng 506 đến 569 của tệp gốc; pattern tương tự HoSoHangNam và DanhHieuHangNam,
//   khác duy nhất ở khoá ngoại (co_quan_don_vi_id hoặc don_vi_truc_thuoc_id thay cho quan_nhan_id)
//   và việc unit không có chuỗi CSTDTQ.

// 22. Bảng File Quyết định
model FileQuyetDinh {
  id               String   @id @default(cuid()) @db.VarChar(30)
  ...
  // Reverse relations: hard FK từ 8 bảng khen thưởng. onUpdate: Cascade (rename số quyết định
  // sẽ tự lan toả); onDelete: Restrict (không cho xoá file quyết định khi đang được tham chiếu).
...
// 23. Bảng cấu hình hệ thống (key-value)
model SystemSetting {
  id        String   @id @default(cuid()) @db.VarChar(30)
...
|---|---|---|---|---|---|
| 1 | `/api/auth` | `auth.route.ts` | Public + USER | 4 | Đăng nhập, làm mới refresh token, đăng xuất, đổi mật khẩu |
| 2 | `/api/accounts` | `account.route.ts` | SUPER_ADMIN | 6 | Quản trị tài khoản: liệt kê, xem chi tiết, tạo, đặt lại mật khẩu, sửa, xoá |
| 3 | `/api/units` | `unit.route.ts` | MANAGER trở lên | 6 | Liệt kê đơn vị mình quản lý, lấy cây CQĐV–ĐVTT đầy đủ, CRUD đơn vị (ADMIN) |
| 4 | `/api/sub-units` | (`index.ts`) | ADMIN | 1 | Lấy danh sách Đơn vị trực thuộc phẳng phục vụ select-box |
| 5 | `/api/positions` | `position.route.ts` | MANAGER trở lên | 4 | CRUD chức vụ; lấy hệ số chức vụ; chỉ ADMIN được sửa/xoá |
| 6 | `/api/personnel` | `personnel.route.ts` | USER trở lên | 7 | Liệt kê quân nhân theo đơn vị; xem chi tiết hồ sơ; CRUD (ADMIN) |
| 7 | `/api/personnel/:id/...` | `personnelNested.route.ts` | MANAGER trở lên | 9 | Quản lý hồ sơ con của 1 quân nhân (lịch sử chức vụ, danh hiệu, NCKH) |
| 8 | `/api/position-history` | `positionHistory.route.ts` | USER trở lên | 4 | Quản lý lịch sử chức vụ; phục vụ tính thời gian cống hiến HCBVTQ |
| 9 | `/api/annual-rewards` | `annualReward.route.ts` | MANAGER trở lên | 14 | CRUD danh hiệu hằng năm cá nhân; import/xuất Excel; lấy template; xem theo năm |
| 10 | `/api/scientific-achievements` | `scientificAchievement.route.ts` | MANAGER trở lên | 8 | CRUD thành tích NCKH (đề tài/sáng kiến); import Excel theo template |
| 11 | `/api/proposals` | `proposal.route.ts` | MANAGER trở lên | 11 | Tạo đề xuất bảy loại; xem trước import; gửi; phê duyệt; từ chối; xoá |
| 12 | `/api/decisions` | `decision.route.ts` | ADMIN | 13 | Quản lý số quyết định, autocomplete khi gắn quyết định, tải file PDF |
| 13 | `/api/awards/units/annual` | `unitAnnualAward.route.ts` | MANAGER trở lên | 19 | Khen thưởng đơn vị hằng năm: ĐVQT/BKBTBQP/BKTTCP, recalc, import Excel |
| 14 | `/api/tenure-medals` | `tenureMedal.route.ts` | MANAGER trở lên | 8 | Huy chương Chiến sĩ vẻ vang (HCCSVV) niên hạn 10/15/20 năm |
| 15 | `/api/contribution-medals` | `contributionMedal.route.ts` | MANAGER trở lên | 7 | Huân chương Bảo vệ Tổ quốc (HCBVTQ) cống hiến theo nhóm hệ số |
| 16 | `/api/commemorative-medals` | `commemorativeMedal.route.ts` | MANAGER trở lên | 8 | Kỷ niệm chương vì sự nghiệp xây dựng QĐNDVN (lifetime) |
| 17 | `/api/military-flags` | `militaryFlag.route.ts` | MANAGER trở lên | 8 | Huy chương Quân kỳ quyết thắng (25 năm phục vụ) |
| 18 | `/api/awards` | `awards.route.ts` | USER trở lên | 4 | Danh sách khen thưởng tổng hợp của một quân nhân; thống kê theo năm |
| 19 | `/api/adhoc-awards` | `adhocAward.route.ts` | ADMIN/MANAGER | 7 | Khen thưởng đột xuất cho cá nhân và tập thể (giấy khen, bằng khen) |
| 20 | `/api/profiles` | `profile.route.ts` | USER trở lên | 8 | Hồ sơ suy diễn (annual/tenure/cong-hien), check-eligibility, recalc-all |
| 21 | `/api/system-logs` | `systemLogs.route.ts` | MANAGER trở lên | 5 | Tra cứu nhật ký kiểm toán theo bộ lọc; xoá log (SUPER_ADMIN) |
| 22 | `/api/dashboard` | `dashboard.route.ts` | ADMIN trở lên | 3 | Số liệu tổng quan cho trang chủ theo vai trò |
| 23 | `/api/notifications` | `notification.route.ts` | USER trở lên | 6 | Thông báo thời gian thực; đánh dấu đã đọc; xoá |
| 24 | `/api/dev-zone` | `devZone.route.ts` | Mật khẩu nội bộ | 11 | Khu kỹ thuật ẩn: kích hoạt cron sao lưu, tính lại số lượng đơn vị, bật/tắt feature flag |

**Quy ước phân quyền.** Vai trò "USER trở lên" nghĩa là cả USER, MANAGER, ADMIN, SUPER_ADMIN đều có thể gọi. Vai trò "MANAGER trở lên" loại USER khỏi danh sách. Một số endpoint đọc (như `/api/awards/...`) áp thêm `unitFilter` để giới hạn dữ liệu trả về theo cây đơn vị mà tài khoản MANAGER quản lý — cơ chế này được mô tả trong §2.4.2 và §5.5.

**Bảo vệ dev-zone.** Toàn bộ endpoint dưới `/api/dev-zone` không dùng JWT; thay vào đó áp middleware `verifyDevPassword` đối chiếu với mật khẩu cấu hình tại biến môi trường `DEV_ZONE_PASSWORD`. Kèm rate-limit `authLimiter` để phòng dò mật khẩu.

---

# Phụ lục C. Hướng dẫn sử dụng theo vai trò

Phụ lục này hướng dẫn các thao tác cơ bản theo bốn vai trò người dùng đã định nghĩa trong §1.2 và §2.2. Quy ước trình bày: mỗi vai trò gồm phần *Truy cập*, *Các thao tác chính* (đánh số), và *Lưu ý* khi vận hành thực tế.

## C.1 Vai trò SUPER_ADMIN — bộ phận kỹ thuật và công nghệ thông tin

**Truy cập.** Tài khoản SUPER_ADMIN được tạo lần đầu thông qua kịch bản seed `npx tsx src/scripts/initSuperAdmin.ts` ngay sau khi cài đặt phần mềm. Sau đó truy cập tại `https://<server>/login`, sau đăng nhập sẽ vào bảng điều khiển *Quản trị hệ thống*.

**Các thao tác chính.**
1. **Quản lý tài khoản:** vào *Quản trị → Tài khoản* để tạo tài khoản cho cán bộ Phòng Chính trị (vai trò ADMIN), cán bộ chỉ huy đơn vị (MANAGER) và cá nhân (USER). Có thể đặt lại mật khẩu, vô hiệu hoá hoặc xoá tài khoản.
2. **Theo dõi nhật ký hệ thống:** vào *Quản trị → Nhật ký* để xem toàn bộ thao tác có thay đổi dữ liệu, lọc theo người thực hiện, theo tài nguyên, theo khoảng thời gian. Nhật ký nhóm `resource = backup` chỉ hiển thị với vai trò này.
3. **Quản lý sao lưu cơ sở dữ liệu:** vào *Quản trị → DevZone → Backup* để thiết lập lịch chạy `pg_dump`, kích hoạt sao lưu thủ công, tải xuống tệp `.sql` đã sao lưu, đặt số ngày lưu trữ tự động.
4. **Bật/tắt module ẩn:** truy cập *DevZone → Tính năng* để bật cờ điều khiển các tính năng đang thử nghiệm. Cần nhập mật khẩu dev-zone (cấu hình ở biến môi trường `DEV_ZONE_PASSWORD`).

**Lưu ý.** Vai trò này không tham gia nghiệp vụ khen thưởng. Mọi thao tác CRUD trên dữ liệu nghiệp vụ phải uỷ quyền cho ADMIN. SUPER_ADMIN chịu trách nhiệm an ninh hệ thống và khôi phục thảm hoạ.

## C.2 Vai trò ADMIN — cán bộ Phòng Chính trị

**Truy cập.** ADMIN do SUPER_ADMIN cấp tài khoản. Sau khi đăng nhập sẽ vào bảng điều khiển *Tổng quan*, hiển thị thống kê đề xuất chờ duyệt và biểu đồ phân loại danh hiệu theo năm.

**Các thao tác chính.**
1. **Quản lý quân nhân và đơn vị:** vào *Quản lý → Quân nhân* để tạo, sửa, xoá hồ sơ quân nhân; điều chuyển đơn vị; nhập hàng loạt qua Excel. Tương tự cho *Cơ quan đơn vị*, *Đơn vị trực thuộc* và *Chức vụ*.
2. **Tạo đề xuất khen thưởng:** vào *Đề xuất → Tạo mới*, chọn một trong bảy loại (cá nhân hằng năm, đơn vị hằng năm, niên hạn HCCSVV, cống hiến HCBVTQ, kỷ niệm chương, quân kỳ quyết thắng, NCKH). Hệ thống sẽ tự lọc danh sách quân nhân đủ điều kiện kèm gợi ý sẵn để ADMIN tích chọn.
3. **Phê duyệt đề xuất:** vào *Đề xuất → Chờ duyệt* để xem các đề xuất do MANAGER gửi lên. Có thể chỉnh sửa danh hiệu (ví dụ hạ hạng huy chương), gắn số quyết định, tải lên tệp PDF quyết định, sau đó *Phê duyệt* hoặc *Từ chối* kèm lý do.
4. **Tính lại tổng thể:** vào *Hồ sơ → Tính lại tất cả* trước mỗi đợt xét lớn (đầu năm). Lệnh sẽ chạy `recalculateAnnualProfile` cho toàn bộ quân nhân đang phục vụ và cập nhật cờ `du_dieu_kien_*` để thống kê đầu vào cho đợt xét.
5. **Xuất báo cáo:** vào *Báo cáo → Xuất Excel* để xuất danh sách khen thưởng theo nhiều tiêu chí (theo năm, theo loại, theo đơn vị) phục vụ tổng hợp gửi cấp trên.

**Lưu ý.** ADMIN nhìn thấy dữ liệu của toàn Học viện. Khi gắn số quyết định cho nhiều quân nhân, nên dùng tính năng autocomplete để tránh trùng số. File PDF quyết định một khi đã gắn không thể bị xoá nếu còn bản ghi tham chiếu (ràng buộc `onDelete: Restrict` trên `FileQuyetDinh`).

## C.3 Vai trò MANAGER — chỉ huy cơ quan, đơn vị

**Truy cập.** MANAGER do ADMIN tạo tài khoản, gắn với một Cơ quan đơn vị (CQĐV) hoặc Đơn vị trực thuộc (ĐVTT). Sau khi đăng nhập sẽ vào bảng điều khiển hiển thị danh sách quân nhân thuộc đơn vị mình kèm cờ đủ điều kiện cho từng loại khen thưởng.

**Các thao tác chính.**
1. **Quản lý quân nhân nội bộ:** vào *Quân nhân → Đơn vị tôi* để xem danh sách quân nhân của đơn vị; cập nhật chức vụ, lịch sử công tác; ghi nhận thành tích NCKH.
2. **Đề xuất khen thưởng cho đơn vị mình:** vào *Đề xuất → Tạo mới*, chọn loại đề xuất, hệ thống tự lọc quân nhân đủ điều kiện trong cây đơn vị mình quản lý. Sau khi tích chọn, bấm *Gửi đề xuất*; trạng thái chuyển PENDING và gửi thông báo thời gian thực cho ADMIN.
3. **Theo dõi tiến độ:** vào *Đề xuất → Của tôi* để xem các đề xuất đã gửi cùng trạng thái (PENDING/APPROVED/REJECTED). Nếu bị từ chối, đọc *Lý do* để chỉnh sửa và gửi lại.
4. **Xem nhật ký nội bộ:** vào *Nhật ký* để theo dõi thao tác trên dữ liệu thuộc cây đơn vị mình; không xem được dữ liệu của đơn vị khác.

**Lưu ý.** MANAGER chỉ thấy được dữ liệu thuộc cây đơn vị của mình do middleware `unitFilter`. Khi điều chuyển quân nhân ra khỏi đơn vị, MANAGER cũ sẽ không còn quyền xem hồ sơ của quân nhân đó.

## C.4 Vai trò USER — cán bộ, học viên, sĩ quan

**Truy cập.** USER do ADMIN cấp tài khoản, gắn với một quân nhân cụ thể qua trường `quan_nhan_id`. Sau đăng nhập sẽ vào trang *Hồ sơ của tôi*.

**Các thao tác chính.**
1. **Tra cứu hồ sơ cá nhân:** vào *Hồ sơ của tôi* để xem thông tin nhân thân, lịch sử chức vụ, lịch sử khen thưởng được sắp xếp theo năm.
2. **Xem chi tiết chuỗi danh hiệu:** vào *Khen thưởng → Chuỗi danh hiệu* để xem tiến trình BKBTBQP/CSTĐTQ/BKTTCP của bản thân kèm thông điệp gợi ý do hệ thống sinh tự động (ví dụ: *"Còn 1 năm CSTĐCS nữa để đủ điều kiện đề nghị BKBTBQP"*).
3. **Xem các thông báo cá nhân:** biểu tượng chuông trên thanh điều hướng hiện thông báo khi có quyết định mới được phê duyệt liên quan đến mình.
4. **Đổi mật khẩu:** vào *Tài khoản → Đổi mật khẩu*; hệ thống yêu cầu mật khẩu cũ và mật khẩu mới đáp ứng tối thiểu 8 ký tự.

**Lưu ý.** USER chỉ xem được hồ sơ của chính mình; không có quyền tạo, sửa, xoá bất kỳ dữ liệu nghiệp vụ nào. Nếu phát hiện sai lệch trong hồ sơ cá nhân, cần báo MANAGER hoặc cán bộ Phòng Chính trị để chỉnh sửa.
...
| # | Thư mục | Phạm vi kiểm thử | Số bộ kiểm thử | Số ca kiểm thử (tham khảo) | Trạng thái |
|---|---|---|---|---|---|
| 1 | `tests/services/eligibility-bkbqp-personal` | Rule eligibility BKBTBQP cá nhân, các kịch bản chu kỳ trượt 2 năm | 9 | ≈ 95 | Pass 100 % |
| 2 | `tests/services/eligibility-cstdtq-personal` | Rule CSTĐTQ cá nhân, cửa sổ trượt 3 năm có BKBTBQP | 8 | ≈ 80 | Pass 100 % |
| 3 | `tests/services/eligibility-bkttcp-personal` | Rule BKTTCP cá nhân, lifetime block, đếm `=== 3` BKBTBQP và `=== 2` CSTĐTQ | 7 | ≈ 60 | Pass 100 % |
| 4 | `tests/services/eligibility-bkbqp-unit` | Rule BKBTBQP đơn vị, chu kỳ ĐVQT 2 năm | 6 | ≈ 50 | Pass 100 % |
| 5 | `tests/services/eligibility-bkttcp-unit` | Rule BKTTCP đơn vị, non-lifetime, cửa sổ trượt 7 năm | 5 | ≈ 45 | Pass 100 % |
| 6 | `tests/services/chainContext` | Hàm `computeChainContext`, `lastFlagYearInChain`, dẫn xuất ngữ cảnh | 4 | ≈ 30 | Pass 100 % |
| 7 | `tests/services/chainCycleScenarios` | Kịch bản tổng hợp lỡ đợt, lặp chu kỳ, BKBTBQP rơi khỏi cửa sổ | 6 | ≈ 80 | Pass 100 % |
| 8 | `tests/scenarios` | Kịch bản end-to-end: đề xuất → phê duyệt → recalc → audit | 8 | ≈ 110 | Pass 100 % |
| 9 | `tests/approve` | Phê duyệt từng loại đề xuất (CA_NHAN_HANG_NAM, DON_VI_HANG_NAM, NIEN_HAN, CONG_HIEN, NCKH, KNC, HC_QKQT) | 7 | ≈ 90 | Pass 100 % |
| 10 | `tests/submit` | Submit đề xuất: validation, dispatch theo strategy, build payload | 5 | ≈ 60 | Pass 100 % |
| 11 | `tests/import` | Import Excel theo từng loại; preview validation; rollback transaction | 6 | ≈ 70 | Pass 100 % |
| 12 | `tests/auth` | Đăng nhập, làm mới refresh token, đổi mật khẩu, đăng xuất | 4 | ≈ 35 | Pass 100 % |
...
**Bảng D.2 — Mẫu output console của Jest**

```text
PASS  tests/services/eligibility-bkbqp-personal.test.ts
PASS  tests/services/eligibility-cstdtq-personal.test.ts
PASS  tests/services/eligibility-bkttcp-personal.test.ts
PASS  tests/services/chainContext.test.ts
PASS  tests/services/chainCycleScenarios.test.ts
PASS  tests/scenarios/approveAndRecalc.test.ts
PASS  tests/approve/personalAnnual.test.ts
PASS  tests/approve/unitAnnual.test.ts
PASS  tests/import/personalAnnualImport.test.ts
...
**Cấu hình kiểm thử.** Các bộ kiểm thử dùng `ts-jest` để chạy trực tiếp tệp `.ts` không cần biên dịch trước; cấu hình tại `jest.config.ts`. Môi trường `tests/env.setup.ts` thiết lập biến môi trường giả cho test, tách biệt với cơ sở dữ liệu thực qua biến `DATABASE_URL` trỏ về schema test. Lệnh `npm run test:coverage` sinh báo cáo phủ test (coverage) HTML tại `coverage/lcov-report/index.html` — tỉ lệ phủ tính theo dòng đạt trên 85 % cho các thư mục `services/profile`, `services/eligibility` và `services/proposal`.
