...
- **Thông báo thời gian thực** sử dụng Socket.IO, chủ yếu thông báo kết quả nhập Excel lớn và biến cố phê duyệt cho người tạo đề xuất.
...
- Thông báo realtime qua Socket.IO khi có đề xuất mới, được phê duyệt hoặc nhập Excel hoàn tất.
