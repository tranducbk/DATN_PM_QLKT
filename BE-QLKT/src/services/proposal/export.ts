...
import { styleHeaderRow } from '../../helpers/excelTemplateHelper';
import { PROPOSAL_TYPES } from '../../constants/proposalTypes.constants';
import { PROPOSAL_STATUS } from '../../constants/proposalStatus.constants';

/**
 * Generates a proposal template scoped to the requesting user's unit context.
 * @param {number} userId - Requesting account ID
 * @param {string} type - Proposal type key used to pick annual vs tenure-style template
...
/**
 * Builds a tenure-specific template to prevent schema mixing during imports.
 * @param {ExcelJS.Workbook} workbook - Target workbook
 * @param {Array} quanNhanList - Personnel rows
 * @returns {Promise<Buffer>} Excel workbook buffer
 */
...
/**
 * Exports submitted proposal data for admin-side review and audit workflows.
