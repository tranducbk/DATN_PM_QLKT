 ...
 */
async function getUserWithUnit(userId) {
 ...
 */
async function getProposals(userId, userRole, page = 1, limit = 10) {
  try {
 ...
 */
async function getProposalById(proposalId, userId, userRole) {
  try {
