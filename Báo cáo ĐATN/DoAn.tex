...
\usepackage{listings}
\lstdefinestyle{shell}{basicstyle=\ttfamily\small,xleftmargin=1.5em,breaklines=true,showstringspaces=false,aboveskip=0.8em,belowskip=0.4em}
\usepackage{float}
...
\fancyfoot[RE, LO]{\thepage} % match body pages — page number at outer corner
...
\bibitem{layeredref} Microsoft, Common web application architectures. [Online]. Available: \url{https://learn.microsoft.com/dotnet/architecture/modern-web-apps-azure/common-web-application-architectures} (visited on 02/03/2026).
\end{thebibliography}
