...
Fastify cho thông lượng cao hơn Express trong một số benchmark nhưng dùng cơ chế xác thực gắn cứng với JSON Schema, gây trùng lặp với Zod đã chọn cho frontend ở Mục~\ref{section:3.7}.
...
Để xác thực không trạng thái giữa frontend và API server tách rời, hệ thống áp dụng JWT theo chuẩn RFC 7519 \cite{rfc7519}, hiện thực bằng thư viện jsonwebtoken 9.
