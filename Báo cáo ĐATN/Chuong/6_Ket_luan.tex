...
Đối chiếu với các mục tiêu đặt ra ở Chương~\ref{chapter:Introduction}, đồ án đã đạt được phần lớn yêu cầu. Mục tiêu số hóa quy trình khen thưởng đã đạt khi toàn bộ vòng đời đề xuất và phê duyệt được đưa lên phần mềm. Mục tiêu tự động xét chuỗi điều kiện danh hiệu đã đạt với động cơ xét điều kiện dùng chung cho cả cá nhân và đơn vị. Mục tiêu phân quyền theo tổ chức đã đạt với bốn vai trò và phạm vi dữ liệu theo cây đơn vị. Mục tiêu nhật ký và kiểm chứng đã đạt với hệ thống ghi nhật ký đầy đủ cùng bộ kiểm thử tự động. Mục tiêu triển khai nội bộ mới đạt một phần khi hệ thống đã chạy ổn định trên mạng nội bộ Học viện nhưng chưa qua giai đoạn thử nghiệm với người dùng thật.
...
Các quy tắc xét chuỗi cho cá nhân và đơn vị, tình huống lỡ đợt đề nghị, điều kiện tính trên cửa sổ thời gian gần nhất và quy tắc chặn nhận lại danh hiệu chỉ trao một lần đều đã được kiểm chứng bằng bộ kiểm thử tự động với nhiều bộ dữ liệu mẫu.
...
Trong quá trình thực hiện, đồ án rút ra một số kinh nghiệm chuyên môn, bao gồm: (i) tách biệt quy tắc nghiệp vụ phức tạp ra khỏi mã nguồn thông qua cấu hình tập trung; (ii) thiết kế kiến trúc phân tầng với ranh giới rõ giữa các tầng; (iii) phân tích các tình huống phức tạp khi điều kiện danh hiệu được xét trên cửa sổ thời gian trượt, chẳng hạn ba năm gần nhất; và (iv) chuyển đổi văn bản pháp lý và quy chế nội bộ thành thiết kế kỹ thuật.
...
\textbf{(iv) Tích hợp ký số quân đội.} Bổ sung mô-đun ký số cho tệp PDF quyết định khen thưởng theo chuẩn PKCS\#7, với chữ ký số do hệ thống PKI của Bộ Quốc phòng cấp.
...
\textbf{(v) Hộp thoại trao đổi (chat) trong hệ thống.} Bổ sung kênh nhắn tin trực tiếp giữa các vai trò Chỉ huy đơn vị, Cán bộ Phòng Chính trị và quân nhân ngay trong ứng dụng.
