...
Về mặt kỹ thuật, hệ thống tổ chức theo kiến trúc phân tầng từ tầng định tuyến đến tầng truy cập dữ liệu.
...
Quy tắc chuỗi cá nhân và đơn vị, các kịch bản lỡ đợt, điều kiện theo khoảng năm gần nhất tính lùi và quy tắc chặn nhận lại với danh hiệu một lần duy nhất đều đã được kiểm chứng bằng bộ kiểm thử tự động cùng nhiều bộ dữ liệu mẫu.
...
Tương tự, bảy loại đề xuất đều tuân theo cùng giao diện Strategy với một registry trung tâm.
Cách tổ chức này giảm đáng kể các nhánh điều kiện cứng trong mã nguồn và mở đường cho việc bổ sung loại đề xuất mới trong vài tệp riêng lẻ.
...
Thứ hai, các báo cáo thống kê hiện chủ yếu dưới dạng bảng và biểu đồ tĩnh, chưa cung cấp công cụ phân tích so sánh giữa các đơn vị trong chuỗi thời gian dài.
...
Trong quá trình thực hiện, đồ án rút ra một số kinh nghiệm chuyên môn, bao gồm: (i) tách biệt quy tắc nghiệp vụ phức tạp ra khỏi mã nguồn thông qua cấu hình tập trung; (ii) thiết kế kiến trúc phân tầng với ranh giới rõ giữa các tầng; (iii) phân tích các tình huống phức tạp khi điều kiện danh hiệu được xét theo khoảng năm gần nhất tính lùi; và (iv) chuyển đổi văn bản pháp lý và quy chế nội bộ thành thiết kế kỹ thuật.
...
Theo Điều 8 Luật Thi đua, Khen thưởng, có thể kể đến khen thưởng phong trào thi đua theo chuyên đề như an toàn giao thông hay học tập và làm theo tư tưởng Hồ Chí Minh, và khen thưởng đối ngoại với các hình thức như Huân chương Hữu nghị dành cho cá nhân, tập thể người nước ngoài.
...
\textbf{(iii) Triển khai cho nhiều đơn vị trong toàn quân.} Phiên bản hiện tại thiết kế cho riêng Học viện Khoa học Quân sự với cây tổ chức hai cấp gồm cơ quan đơn vị và đơn vị trực thuộc.
Hướng tiếp theo là mở rộng mô hình tổ chức thành nhiều cấp như Quân khu, Quân đoàn, Học viện, Trường và Đơn vị cơ sở.
Cùng với đó là hỗ trợ multi-tenancy để các đơn vị khác trong toàn quân dùng chung hạ tầng phần mềm mà vẫn cách ly dữ liệu nghiệp vụ.
Khi đó, hệ thống có thể trở thành nền tảng dùng chung cấp Bộ Quốc phòng thay vì giải pháp riêng của một học viện.

\textbf{(iv) Tích hợp ký số quân đội.} Bổ sung mô-đun ký số PDF quyết định khen thưởng theo chuẩn PKCS\#7 với chữ ký số do hệ thống PKI của Bộ Quốc phòng cấp.
...
\textbf{(v) Hộp thoại trao đổi (chat) trong hệ thống.} Bổ sung kênh nhắn tin trực tiếp giữa các vai trò Chỉ huy đơn vị, Phòng Chính trị và quân nhân ngay trong ứng dụng.
Kênh này cho phép gửi kèm tệp đính kèm trong quá trình lập, trao đổi và phê duyệt đề xuất, thay cho việc liên hệ qua điện thoại hay giấy tờ.
...
Các hướng (i), (ii), (iv) và (v) khả thi trong sáu tháng kế tiếp nhờ kiến trúc cấu hình kết hợp Strategy và hạ tầng Socket.IO đã có.
