...
Đối chiếu với các mục tiêu đặt ra ở Chương~\ref{chapter:Introduction}, đồ án đã đạt được phần lớn yêu cầu. Mục tiêu số hóa quy trình khen thưởng đã đạt khi toàn bộ vòng đời đề xuất và phê duyệt được đưa lên phần mềm. Mục tiêu tự động xét chuỗi điều kiện danh hiệu đã đạt với cơ chế xét điều kiện dùng chung cho cả cá nhân và đơn vị. Mục tiêu phân quyền theo tổ chức đã đạt với bốn vai trò và phạm vi dữ liệu theo cây đơn vị. Mục tiêu nhật ký và kiểm chứng đã đạt với hệ thống ghi nhật ký đầy đủ cùng bộ kiểm thử tự động. Mục tiêu triển khai nội bộ mới đạt một phần khi hệ thống đã chạy ổn định trên mạng nội bộ Học viện nhưng chưa qua giai đoạn thử nghiệm với người dùng thật.
