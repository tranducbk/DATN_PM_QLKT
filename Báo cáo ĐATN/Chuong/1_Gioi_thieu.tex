...
Phân quyền cũng chỉ dừng ở mức thư mục dùng chung, chưa phản ánh được cơ cấu tổ chức thực tế của Học viện gồm cấp Phòng, cấp Khoa và từng quân nhân.
...
Đồng thời, phần mềm cần hợp nhất bảy nhóm nghiệp vụ đang nằm rải rác về một nơi, ghi vết mọi thao tác sửa đổi dữ liệu và phân quyền theo đúng cơ cấu tổ chức từ cấp Phòng, cấp Khoa đến từng quân nhân.
Đây chính là bài toán mà đồ án hướng tới giải quyết.

\section{Mục tiêu và phạm vi đề tài}
\label{section:1.2}

Để khắc phục những hạn chế nêu trên, mục tiêu chính của đồ án là xây dựng một hệ thống web hỗ trợ Phòng Chính trị Học viện Khoa học Quân sự thực hiện các nhóm nhiệm vụ chính sau:
...
Phần mềm vận hành tập trung trên máy chủ của Học viện, truy cập qua mạng nội bộ và không công khai ra Internet công cộng để đáp ứng yêu cầu bảo mật quân sự.
...
Sản phẩm đã được kiểm thử thủ công qua giao diện, kết hợp bộ kiểm thử tự động bao phủ các kịch bản nghiệp vụ cốt lõi.
