...
Thứ ba, các tệp dùng chung không có cơ chế lưu vết thao tác.
...
Nổi bật là cơ chế xét điều kiện chuỗi danh hiệu thống nhất cho cả cá nhân và đơn vị. Bên cạnh đó, bảy nhóm khen thưởng vốn rời rạc được hợp nhất vào một quy trình chung từ đề xuất, thêm số quyết định đến phê duyệt. Cuối cùng, nhật ký hệ thống ghi vết mọi thao tác làm thay đổi dữ liệu.
