...
\begin{itemize}
    ...
    \item Kỷ niệm chương, hiện có Kỷ niệm chương vì sự nghiệp xây dựng Quân đội nhân dân Việt Nam (KNC), xét theo số năm công tác với mốc khác nhau giữa nam và nữ.
...
Sản phẩm đã được kiểm thử thủ công qua giao diện và kiểm chứng trên nhiều kịch bản nghiệp vụ cốt lõi với dữ liệu mẫu.
