...
Bên cạnh khen thưởng cá nhân và đơn vị hằng năm, Học viện còn xét các nhóm sau:

\begin{itemize}
    \item Huy chương Chiến sĩ vẻ vang (HCCSVV) xét theo mốc 10, 15, 20 năm phục vụ.
    \item Huân chương Bảo vệ Tổ quốc (HCBVTQ) xét theo thời gian giữ chức vụ.
    \item Kỷ niệm chương vì sự nghiệp xây dựng Quân đội nhân dân Việt Nam (KNC) xét theo số năm công tác, với mốc khác nhau giữa nam và nữ.
    \item Huy chương Quân kỳ quyết thắng (HCQKQT) cho người phục vụ đủ 25 năm.
    \item Thành tích nghiên cứu khoa học (NCKH) là điều kiện bắt buộc khi xét các danh hiệu cấp cao trong khen thưởng cá nhân hằng năm.
\end{itemize}

Mỗi nhóm có tiêu chuẩn xét duyệt riêng, lại lưu rải rác trong nhiều tệp. Vì vậy dữ liệu khó kiểm tra và khó giữ được sự nhất quán.
...
Những hạn chế trên cho thấy Học viện cần một phần mềm chuyên dụng, bám sát chính đặc thù của công tác khen thưởng tại đơn vị.
Phần mềm phải thay thế việc đối chiếu thủ công lịch sử danh hiệu bằng cơ chế tự động kiểm tra các điều kiện khen thưởng chuỗi.
Đồng thời, phần mềm cần hợp nhất bảy nhóm nghiệp vụ đang nằm rải rác về một nơi, ghi vết mọi thao tác sửa đổi dữ liệu và phân quyền theo đúng cây tổ chức từ cấp Phòng, cấp Khoa đến từng quân nhân.
...
\begin{enumerate}
    ...
    \item \textbf{Tự động hoá nghiệp vụ}: kiểm tra điều kiện chuỗi danh hiệu cho cá nhân (BKBQP, CSTĐTQ, BKTTCP) và đơn vị (BKBQP, BKTTCP), tự động sinh nội dung gợi ý bằng tiếng Việt, nhập lịch sử khen thưởng từ Excel theo cơ chế xem trước rồi xác nhận, và xuất danh sách theo nhiều tiêu chí. Quá trình nhập tuân thủ nguyên tắc toàn vẹn giao dịch: hoặc ghi nhận toàn bộ, hoặc hoàn tác hoàn toàn.
...
Sản phẩm đã được kiểm thử thủ công qua giao diện, kết hợp bộ kiểm thử tự động bao phủ các kịch bản nghiệp vụ lõi.
Trên cơ sở đó, phần mềm có thể dùng để triển khai thử nghiệm tại Phòng Chính trị Học viện.
