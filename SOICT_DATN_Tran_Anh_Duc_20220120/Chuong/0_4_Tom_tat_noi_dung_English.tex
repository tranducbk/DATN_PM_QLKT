...
The system is deployed as a web application on the Academy's internal network (LAN). Chain-award rules are extracted into a central configuration so that new awards can be added without altering the eligibility logic. The deliverable supports four authorisation levels adapted to military organisational specifics (SuperAdmin, Admin, Manager, User) and ships with more than 890 unit tests covering both personal and unit chain rules, ready for pilot deployment at the Political Department.
