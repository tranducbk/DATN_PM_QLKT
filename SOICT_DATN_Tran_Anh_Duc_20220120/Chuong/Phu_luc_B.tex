...
Luồng chính &
(1) Truy cập trang ``Nhật ký hệ thống''; hệ thống hiển thị bảng ghi với các cột: thời gian, người thực hiện, vai trò, loại hành động, nhóm chức năng, mô tả. (2) Áp dụng bộ lọc theo nhóm chức năng, loại hành động, người thực hiện, khoảng thời gian. (3) Hệ thống lọc kết quả theo vai trò: Manager chỉ thấy bản ghi thuộc phạm vi đơn vị mình quản lý; Admin và Manager không thấy nhật ký sao lưu (chỉ SuperAdmin mới xem được). (4) Trả về danh sách đã phân trang. (5) Nhấn vào một bản ghi để xem chi tiết nội dung thay đổi trước và sau trong hộp thoại. \\ \hline
Luồng thay thế &
(3a) Admin hoặc Manager cố xem nhật ký sao lưu $\rightarrow$ hệ thống tự động lọc bỏ, không hiển thị bản ghi nào. (3b) Manager chỉ thấy nhật ký do các tài khoản trong phạm vi đơn vị mình quản lý thực hiện. \\ \hline
