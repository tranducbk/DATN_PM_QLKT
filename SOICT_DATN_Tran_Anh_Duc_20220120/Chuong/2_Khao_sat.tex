...
\multirow{4}{*}{\textbf{Luồng sự kiện thay thế}}
 ...
 & 5a. & Hệ thống & Sau ba lần sai liên tiếp, áp giới hạn 5 phút theo địa chỉ IP \\ \hline
...
\multirow{9}{*}{\parbox{3.2cm}{\centering\textbf{Luồng sự kiện chính}\\\textbf{(Thành công)}}}
 ...
 & 2. & Admin & Xem lại danh sách đối tượng và danh hiệu \\ \cline{2-4}
 & 3. & Admin & Có thể chỉnh sửa danh hiệu (vd: hạ từ Hạng Nhất xuống Hạng Nhì) \\ \cline{2-4}
 & 4. & Admin & Nhập số quyết định và tải lên tệp PDF quyết định \\ \cline{2-4}
 & 5. & Admin & Bấm ``Phê duyệt'' \\ \cline{2-4}
 & 6. & Hệ thống & Mở giao dịch: chuyển trạng thái, ghi danh hiệu, gắn quyết định, tính lại hồ sơ suy diễn \\ \cline{2-4}
 & 7. & Hệ thống & Phát thông báo thời gian thực tới Manager đã đề xuất và các quân nhân được khen \\ \cline{2-4}
 & 8. & Hệ thống & Ghi nhật ký với dữ liệu trước, sau khi thay đổi \\ \hline
\multirow{5}{*}{\textbf{Luồng sự kiện thay thế}}
 & \textbf{STT} & \textbf{Thực hiện bởi} & \multicolumn{1}{c|}{\textbf{Hành động}} \\ \cline{2-4}
 & 4a. & Hệ thống & Số quyết định trùng, cảnh báo nhưng cho phép tiếp tục nếu xác nhận \\ \cline{2-4}
 & 5a. & Hệ thống & Đề xuất bị Admin khác sửa cùng lúc, trả lỗi 409 và yêu cầu tải lại \\ \cline{2-4}
 & 5b. & Admin & Từ chối thay vì phê duyệt, đổi trạng thái sang ``Từ chối'' kèm lý do \\ \cline{2-4}
 & 6a. & Hệ thống & Có lỗi tại bước ghi (vd: vi phạm quy tắc một lần duy nhất), huỷ toàn bộ giao dịch \\ \hline
...
\begin{tabular}{|>{\centering\arraybackslash}p{3.2cm}|>{\centering\arraybackslash}p{0.8cm}|p{2.8cm}|p{6.4cm}|}
\hline
\textbf{Tên use case} & \multicolumn{3}{l|}{Tính lại hồ sơ hằng năm và sinh gợi ý đề nghị} \\ \hline
\textbf{Tác nhân} & \multicolumn{3}{p{10.6cm}|}{Admin (kích hoạt chủ động); Hệ thống (tự động sau mỗi lần phê duyệt).} \\ \hline
...
\multirow{6}{*}{\parbox{3.2cm}{\centering\textbf{Luồng sự kiện chính}\\\textbf{(Thành công)}}}
 ...
 & 2. & Hệ thống & Dẫn xuất ngữ cảnh chuỗi (số năm, danh hiệu trong cửa sổ trượt) \\ \cline{2-4}
...
\multirow{4}{*}{\textbf{Luồng sự kiện thay thế}}
 ...
 & 3b. & Hệ thống & Chuỗi CSTĐCS chưa đủ chu kỳ, gợi ý số năm cần tích luỹ thêm \\ \cline{2-4}
...
\begin{tabular}{|>{\centering\arraybackslash}p{3.2cm}|>{\centering\arraybackslash}p{0.8cm}|p{2.8cm}|p{6.4cm}|}
\hline
\textbf{Tên use case} & \multicolumn{3}{l|}{Nhập danh sách quân nhân hoặc danh hiệu hằng năm từ Excel} \\ \hline
\textbf{Tác nhân} & \multicolumn{3}{l|}{Admin} \\ \hline
\textbf{Tiền điều kiện} & \multicolumn{3}{p{10.6cm}|}{Đã có tệp mẫu Excel tải xuống từ hệ thống và điền dữ liệu theo cấu trúc cột chuẩn.} \\ \hline
\multirow{9}{*}{\parbox{3.2cm}{\centering\textbf{Luồng sự kiện chính}\\\textbf{(Thành công)}}}
 & \textbf{STT} & \textbf{Thực hiện bởi} & \multicolumn{1}{c|}{\textbf{Hành động}} \\ \cline{2-4}
 & 1. & Admin & Truy cập ``Nhập Excel'' và chọn loại nghiệp vụ \\ \cline{2-4}
 & 2. & Admin & Tải lên tệp \texttt{.xlsx} qua biểu mẫu \\ \cline{2-4}
 & 3. & Hệ thống & Đọc tệp, kiểm tra cấu trúc và đọc tuần tự từng dòng \\ \cline{2-4}
 & 4. & Hệ thống & Áp schema và quy tắc nghiệp vụ cho mỗi dòng \\ \cline{2-4}
 & 5. & Hệ thống & Trả về bảng xem trước với các dòng hợp lệ và lỗi cụ thể \\ \cline{2-4}
 & 6. & Admin & Kiểm tra danh sách lỗi, nếu đồng ý bấm ``Xác nhận nhập'' \\ \cline{2-4}
 & 7. & Hệ thống & Mở giao dịch, ghi tuần tự các dòng hợp lệ \\ \cline{2-4}
 & 8. & Hệ thống & Commit giao dịch và phát sự kiện thời gian thực tổng kết \\ \hline
\multirow{4}{*}{\textbf{Luồng sự kiện thay thế}}
 & \textbf{STT} & \textbf{Thực hiện bởi} & \multicolumn{1}{c|}{\textbf{Hành động}} \\ \cline{2-4}
 & 3a. & Hệ thống & Tệp sai định dạng hoặc thiếu sheet bắt buộc, trả lỗi 400 \\ \cline{2-4}
 & 4a. & Admin & Có dòng lỗi ở bước xem trước, có thể tải tệp xuống sửa và tải lại \\ \cline{2-4}
 & 7a. & Hệ thống & Có lỗi tại bước ghi, huỷ bỏ toàn bộ giao dịch \\ \hline
\textbf{Hậu điều kiện} & \multicolumn{3}{p{10.6cm}|}{Các bản ghi trong tệp được ghi vào cơ sở dữ liệu; nhật ký \texttt{action = IMPORT} được ghi với tổng kết số dòng thành công và số dòng lỗi; thông báo thời gian thực gửi tới Admin.} \\ \hline
\end{tabular}
\end{table}
