...
export const apiClient = {
  ...
  getTenureMedalsStatistics: awardsApi.getTenureMedalsStatistics,
  deleteTenureMedal: awardsApi.deleteTenureMedal,
  createTenureMedalDirect: awardsApi.createTenureMedalDirect,
  ...
  getContributionMedalsStatistics: awardsApi.getContributionMedalsStatistics,
