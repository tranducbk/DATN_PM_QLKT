            ...
            <Card title="Tài khoản liên kết" className="shadow-sm overflow-hidden">
              <InfoGrid
                items={[
                  {
                    label: 'Username',
                    value: personnel.TaiKhoan.username,
                  },
                  {
                    label: 'Vai trò',
                    value: (
    ...
    },
    {
      ...
      children: (
        <div className="space-y-4">
          <Row gutter={[16, 16]}>
            <Col xs={24} md={8}>
              <Link href={`/manager/personnel/${personnelId}/position-history`}>
                <Card
                  hoverable
            ...
            <Col xs={24} md={8}>
              <Link href={`/manager/personnel/${personnelId}/annual-rewards`}>
                <Card
                  hoverable
                  className="text-center h-full"
                  styles={{
            ...
            <Col xs={24} md={8}>
              <Link href={`/manager/personnel/${personnelId}/scientific-achievements`}>
                <Card
                  hoverable
                  className="text-center h-full"
                  styles={{
          ...
          <Row gutter={[16, 16]}>
            <Col xs={24} md={6}>
              <Link href={`/manager/personnel/${personnelId}/service-rewards`}>
                <Card
                  hoverable
                  className="text-center h-full"
                  styles={{
            ...
            <Col xs={24} md={6}>
              <Link href={`/manager/personnel/${personnelId}/military-flag`}>
                <Card
                  hoverable
                  className="text-center h-full"
                  styles={{
            ...
            <Col xs={24} md={6}>
              <Link href={`/manager/personnel/${personnelId}/commemoration-medals`}>
                <Card
                  hoverable
                  className="text-center h-full"
                  styles={{
            ...
            <Col xs={24} md={6}>
              <Link href={`/manager/personnel/${personnelId}/contribution-awards`}>
                <Card
                  hoverable
                  className="text-center h-full"
                  styles={{
      ...
      <div className="p-6 space-y-6">
        ...
        <Card className="shadow-sm">
          <Tabs
            activeKey={activeTab}
            onChange={key => {
              router.push(`/manager/personnel/${personnelId}?tab=${key}`);
            }}
